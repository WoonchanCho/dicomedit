...
export default class DE6ParserVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	visitDescribeConstantVariable(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by DE6Parser#describeImmutableVariable.
	visitDescribeImmutableVariable(ctx) {
	  return this.visitChildren(ctx);
	}
